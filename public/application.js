...
/***/ (function(module, exports, __webpack_require__) {
	...
	// On document ready
	var preLoadHide = __webpack_require__(35);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://safe-mesa-23831.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onMyIndex = function onMyIndex() {
	  // console.log('inside onMyIndex event')
	  event.preventDefault();
	  api.myIndex().then(ui.onMyIndexSuccess).catch(ui.onMyIndexFailure);
	};

	// adding pets

	var populateAddPetForm = function populateAddPetForm(event) {
	...
	var createpet = function createpet(event) {
	  ...
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.createpet(data).then(ui.createpetSuccess).catch(ui.createpetFailure);
	  $('#create-pet')[0].reset();
	};

	var cancelNew = function cancelNew() {
	...
	var hideNewPet = function hideNewPet(event) {
	...
	var populateUpdatePetForm = function populateUpdatePetForm(event) {
	  ...
	  var pet = $(event.target).data('id');
	  api.showPet(pet).then(ui.onGetPetForUpdateSuccess).catch(ui.onGetPetForUpdateFailure);
	  $('#update-pet').show();
	...
	var onUpdatePet = function onUpdatePet(event) {
	  ...
	  //   return
	  // }
	  api.updatePet(id, data).then(ui.updatepetSuccess).catch(ui.updatepetFailure);
	};
	...
	var hideUpdatePet = function hideUpdatePet(event) {
	...
	var deletePet = function deletePet(event) {
	  ...
	  api.deletePet(id).then(ui.deletePetSuccess)
	  // .then(() => {
	  //   $('.one-blogpost[data-id=' + id + ']').parent().hide('blind')
	  //   $('blockquote[data-id=' + id + ']').hide('blind')
	  // })
	  .then(function () {
	    var numOfPets = $('.pet-content').children().length;
	...
	// other stuff
	var hideSigninShowSignup = function hideSigninShowSignup() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updatePet = function updatePet(id, data) {
	...
	var showPet = function showPet(id) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(12);
	var showPetsHandlerbars = __webpack_require__(14);
	var showMyPetsHandlerbars = __webpack_require__(34);
	var api = __webpack_require__(11);
	...
	var onMyIndexSuccess = function onMyIndexSuccess(data) {
	  hideItems();
	  // console.table(data.pets)
	  // console.log('inside on my index success', data)
	  var showPetsHtml = showMyPetsHandlerbars({ pets: data.pets });
	  $('.well').show();
	  $('.viewAllPets').show();
	  $('.viewAllPets').append(showPetsHtml);
	  $('.delete_myPet').on('click', function (event) {
	    var petDelete = $(event.target).data('id');
	    api.deletePet(petDelete).then(deletePetSuccess).catch(deletePetFailure);
	  });
	  $('.update-myPet').on('click', function (event) {
	    var petUpdate = $(event.target).data('id');
	    event.preventDefault();
	    hideItems();
	    // captures the pet ID input by the user
	    // const pet = $('#updatepettextbox').val()
	    api.showPet(petUpdate).then(onGetPetForUpdateSuccess).catch(onGetPetForUpdateFailure);
	    $('#update-pet').show();
	    $('.well').show();
	    // $('#add-pet-button').show()
	  });
	...
	var onIndexFailure = function onIndexFailure(data) {
	  // look through data returned from server
	  // console.log('inside the onIndexFailure in ui.js', data)
	  hideItems();
	};

	var onMyIndexFailure = function onMyIndexFailure(data) {
	  // look through data returned from server
	  // console.log('inside the onIndexFailure in ui.js', data)
	  hideItems();
	...
	var onGetPetForUpdateSuccess = function onGetPetForUpdateSuccess(data) {
	  // console.table(data)
	...
	var onGetPetForUpdateFailure = function onGetPetForUpdateFailure(data) {
	  hideItems();
	...
	var signInSuccess = function signInSuccess(data) {
	  ...
	  hideItems();
	  api.myIndex().then(onMyIndexSuccess).catch(onMyIndexFailure);
	};
	...
	var deletePetSuccess = function deletePetSuccess(data) {
	...
	var deletePetFailure = function deletePetFailure(data) {
	...
	var createpetFailure = function createpetFailure(error) {
	  hideItems();
	  return error;
	};
	...
	module.exports = {
	  ...
	  onGetPetForUpdateSuccess: onGetPetForUpdateSuccess,
	  onGetPetForUpdateFailure: onGetPetForUpdateFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.pets : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, helper, alias1=container.escapeExpression, alias2=container.lambda;

	  return "   <tr class=\"item\">\n        <td valign=\"top\" class=\"textContent\">\n            <!-- <img src=\"\""
	    + alias1(((helper = (helper = helpers.img || (depth0 != null ? depth0.img : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"img","hash":{},"data":data}) : helper)))
	    + "\" width=\"50\" height=\"75\" class=\"itemImage\"\" /> -->\n\n            <h4 class=\"itemName\">"
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</h4>\n            <span class=\"contentSecondary\"><b>Shot History:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.shots : stack1), depth0))
	    + "</span><br />\n            <span class=\"contentSecondary\"><b>DOB:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.dob : stack1), depth0))
	    + "</span><br />\n            <span class=\"contentSecondary\"><b>Notes:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
	    + "</span><br />\n            <span class=\"contentSecondary\"><data-id=\""
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">ID: "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</span><br />\n        </td>\n    <br>\n\n    </tr>\n    <tr><td> </td></tr>\n";
	},"4":function(container,depth0,helpers,partials,data) {
	    return "    <div><h3>Please add a pet.</h3></div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n<h1 id=\"pets_list\">All Pets in the DB</h1>\n<br><br>\n\n\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.pets : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.pets : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</div>\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, helper, alias1=container.escapeExpression, alias2=container.lambda;
	  ...
	  return "   <tr class=\"item\">\n     <td valign=\"top\" class=\"textContent\">\n       <!-- <img src=\"\""
	    ...
	    + alias1(alias2((depth0 != null ? depth0.shots : depth0), depth0))
	    + "</span><br /> -->\n       <!-- <span class=\"contentSecondary\"><b>DOB:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.dob : stack1), depth0))
	    + "</span><br /> -->\n       <!-- <span class=\"contentSecondary\"><b>Species:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.species : stack1), depth0))
	    + "</span><br /> -->\n       <!-- <span class=\"contentSecondary\"><b>Spayed/Neutered (if yes, enter date):</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.spayed : stack1), depth0))
	    + "</span><br />\n       <span class=\"contentSecondary\"><b>Gender + Species:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.gender : stack1), depth0))
	    + "</span><br /> -->\n       <!-- <span class=\"contentSecondary\"><b>Breed:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.breed : stack1), depth0))
	    + "</span><br /> -->\n       <!-- <span class=\"contentSecondary\"><b>Color + Breed:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.color : stack1), depth0))
	    + "</span><br />\n       <span class=\"contentSecondary\"><b>Purchase Date:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.purchased : stack1), depth0))
	    + "</span><br />\n       <span class=\"contentSecondary\"><b>Microchip:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.microchip : stack1), depth0))
	    + "</span><br />\n       <span class=\"contentSecondary\"><b>Weight:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.weight : stack1), depth0))
	    + "</span><br />\n       <span class=\"contentSecondary\"><b>Vet Contact:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.vet : stack1), depth0))
	    + "</span><br /> -->\n       <!-- <span class=\"contentSecondary\"><b>Veterinarian Phone:</b> "
	    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.vetphone : stack1), depth0))
	    + "</span><br /> -->\n       <!-- <span class=\"contentSecondary\"><b>Notes:</b> "
	    + alias1(alias2((depth0 != null ? depth0.notes : depth0), depth0))
	    + "</span><br />\n       <span class=\"contentSecondary\"><data-id=\""
	    + alias1(alias2((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">Pet ID: "
	    + alias1(alias2((depth0 != null ? depth0.id : depth0), depth0))
	    + "</span><br /> -->\n       <!-- <div>\n         <br>\n         <p><button class=\"btn btn-warning delete_myPet\" name=\"button\" data-id=\""
	    + alias1(alias2((depth0 != null ? depth0.id : depth0), depth0))
	    + "\">Delete</button>\n         &nbsp; &nbsp;<button class=\"btn btn-success update-myPet\" name=\"button\" data-id=\""
	    + alias1(alias2((depth0 != null ? depth0.id : depth0), depth0))
	    ...
	    return "    <div><h3>You have no pets to display at this time.  You may create an pet by selecting the <b>Add A Pet</b> button.</h3></div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n<!-- <h1 id=\"pets_list\">&#10084; My Pets &#10084;</h1> -->\n<h1 class=\"banner\">My Pets</h1>\n<br>\n<!-- <div class=\"printpage\"><A HREF=\"javascript:window.print()\">Print This Page</A></div> -->\n\n<div class=\"row\">\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.pets : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "954d38fafc689a9d34b1022566064047.jpg";
